...
const assessmentHref = (section: string) => `/authorization-pack/{projectId}/assessment?section=${section}`;
const workspaceHref = (tab?: string, category?: string) => {
  const params = new URLSearchParams({ packId: "{packId}" });
  if (tab) params.set("tab", tab);
  if (category) params.set("category", category);
  return `/authorization-pack/workspace?${params.toString()}`;
};
const smcrPsdHref = () => `/smcr/psd?packId={packId}`;
    ...
    items: [
      {
        ...
        smcrLink: '/smcr/forms',
        href: assessmentHref("firm-basics"),
      },
      {
        id: 'psd-individuals',
      ...
      },
      {
        ...
        smcrLink: '/smcr/forms',
        href: assessmentHref("companies-house"),
      },
      {
        id: 'main-contact',
      ...
      },
      {
        ...
        href: assessmentHref("documents-attach"),
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: workspaceHref("documents", "corporate-legal"),
      },
      {
    ...
    items: [
      {
        ...
        href: assessmentHref("programme-operations"),
      },
      {
      ...
      },
      {
        ...
        fcaReference: 'PSR 5.4',
        href: workspaceHref("documents", "programme-operations"),
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        fcaReference: 'SYSC 8',
        href: workspaceHref("documents", "outsourcing-structure"),
      },
      {
    ...
    items: [
      {
        ...
        fcaReference: 'PSR 10',
        href: workspaceHref("documents", "safeguarding"),
      },
      {
    ...
    items: [
      {
        ...
        fcaReference: 'SYSC 4',
        href: workspaceHref("documents", "governance-controls"),
      },
      {
        id: 'cmp',
    ...
    items: [
      {
        ...
        fcaReference: 'PSR 19',
        href: workspaceHref("documents", "it-security"),
      },
      {
        id: 'security-contact',
    ...
    items: [
      {
        ...
        href: workspaceHref("documents", "aml-ctf"),
      },
      {
    ...
    items: [
      {
        ...
        fcaReference: 'SYSC',
        href: workspaceHref("documents", "policies-procedures"),
      },
      {
