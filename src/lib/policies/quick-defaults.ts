...
export const QUICK_QUESTIONS: Record<string, QuickQuestion[]> = {
  ...
  PRODUCT_GOV: [FIRM_NAME_QUESTION, INSURANCE_QUESTION, RETAIL_QUESTION],
  TARGET_MARKET: [FIRM_NAME_QUESTION, INSURANCE_QUESTION, RETAIL_QUESTION],
  RISK_MGMT: [FIRM_NAME_QUESTION, PAYMENT_QUESTION, INVESTMENT_QUESTION],
  COMPLIANCE_MON: [FIRM_NAME_QUESTION, PAYMENT_QUESTION, INVESTMENT_QUESTION],
  OUTSOURCING: [FIRM_NAME_QUESTION, PAYMENT_QUESTION, INVESTMENT_QUESTION],
  INFO_SECURITY: [FIRM_NAME_QUESTION, PAYMENT_QUESTION, INVESTMENT_QUESTION],
  OP_SEC_RISK: [FIRM_NAME_QUESTION, PAYMENT_QUESTION, EMONEY_QUESTION],
  MARKET_ABUSE: [FIRM_NAME_QUESTION, INVESTMENT_QUESTION, PROFESSIONAL_QUESTION],
  INDUCEMENTS: [FIRM_NAME_QUESTION, INVESTMENT_QUESTION, RETAIL_QUESTION],
  CASS: [FIRM_NAME_QUESTION, CLIENT_MONEY_QUESTION, CLIENT_ASSETS_QUESTION],
  CASS_RESOLUTION: [FIRM_NAME_QUESTION, CLIENT_MONEY_QUESTION, CLIENT_ASSETS_QUESTION],
};
