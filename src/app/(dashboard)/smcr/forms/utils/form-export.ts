...
import type { FormAState, FormCState, FormDState, FormEState } from '../types/form-types';
import { prescribedResponsibilitiesList, reasonCategories, controlledFunctions, changeCategories, fitnessCategories, transferReasons } from './form-constants';
