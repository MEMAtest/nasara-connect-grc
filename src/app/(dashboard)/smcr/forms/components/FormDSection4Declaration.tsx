...
interface FormDSection4Props extends FormDSectionProps {
  onExport: () => void;
}

export function FormDSection4Declaration({
  formData,
  updateField,
  onBack,
  onExport,
        ...
        <div className="border rounded-lg p-4 space-y-4">
          ...
          <div className="text-xs text-slate-600 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>The information provided in this amendment notice is accurate and complete to the best of our knowledge</li>
              <li>We have verified the change with the individual concerned where applicable</li>
              <li>We understand that providing false or misleading information is a criminal offence</li>
              <li>We will maintain appropriate records of this amendment</li>
            </ul>
          </div>
