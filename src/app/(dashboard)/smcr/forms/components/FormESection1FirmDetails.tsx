...
export function FormESection1FirmDetails({
  formData,
  updateField,
  validationErrors,
  validateField,
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        <SectionInfo title="About Form E" variant="info">
          <p>Use this form when an approved person is transferring to a different controlled function within the same firm.</p>
          <p className="mt-1"><strong>Processing time:</strong> SMF transfers require FCA approval and take up to 3 months. Do not allow the individual to perform the new function until approved.</p>
        </SectionInfo>
