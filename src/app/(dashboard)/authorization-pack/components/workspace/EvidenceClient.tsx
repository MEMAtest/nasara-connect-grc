...
const EVIDENCE_STATUS_OPTIONS = [
  ...
  { value: "pending", label: "Pending Upload", color: "bg-yellow-100 text-yellow-700", icon: ClockIcon },
  { value: "uploaded", label: "Uploaded", color: "bg-blue-100 text-blue-700", icon: UploadIcon },
  { value: "under_review", label: "Under Review", color: "bg-purple-100 text-purple-700", icon: ClockIcon },
  { value: "approved", label: "Approved", color: "bg-green-100 text-green-700", icon: CheckCircleIcon },
  { value: "rejected", label: "Rejected", color: "bg-red-100 text-red-700", icon: XCircleIcon },
];
...
export function EvidenceClient() {
  ...
  const stats = {
    ...
    uploaded: evidence.filter((e) => ["uploaded", "under_review", "approved"].includes(e.status)).length,
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-semibold text-blue-600">{stats.uploaded}</p>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-4 grid gap-4 md:grid-cols-2">
                        ...
                        {/* File Upload */}
                        <div>
                          <Label className="text-xs text-slate-500">Upload New Version</Label>
                          <div className="mt-1">
                            {!item.file_path && (
                              <div className="mb-2 flex items-center justify-center rounded-lg border-2 border-dashed border-slate-200 px-3 py-4 text-center text-xs text-slate-400">
                                <div>
                                  ...
                                  <p className="mt-1">Drop file or click below</p>
                                </div>
                              </div>
                            )}
                            <Input
