        ...
        >
          <div>
            ...
            <p className="text-xl text-slate-400 leading-relaxed mb-8">
              Nasara Connect unifies governance, risk, and compliance workflows so FCA-regulated teams can
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-lg shadow-emerald-500/50 text-lg px-8"
            >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-2xl text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed">
            Discover how our platform can transform your firm&apos;s regulatory operations and
            strategic advantage.
          </p>
